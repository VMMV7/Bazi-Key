<template>
  <header>
    <div class="flex justify-between items-center">
      <div class="flex">
        <router-link to="#" class="w-[15px] mx-sm"
      ...
      <div class="flex justify-center items-center">
        <div
          class="w-[600px] h-[40px] px-sm text-sm py-sm flex bg-white border mr-[200px]"
        >
          <q-icon class="text-gray-300 text-xl flex-none" name="tune" />
          <input
            type="text"
            placeholder="...کلید واژه مورد نظر"
            class="flex-auto px-xs text-right placeholder:text-gray-300 outline-0 bg-white"
          />
          <q-icon class="text-gray-400 text-xl flex-none" name="search" />
        </div>
        <router-link to="/">
          <img
            src="https://bazikey.com/wp-content/uploads/2022/01/Untitled-1.png"
            width="278"
            height="80"
            alt=""
          />
